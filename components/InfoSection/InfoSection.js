...
const InfoSection = ({lightBg, id, topLine, headLine, description, img,display3D,bg, buttonLable, imgStart, alt, lightText, darkText, dark, dark2, primary,imgDisplay,videoDisplay,video,fname,path,resDisplay }) => {
    return (
        <>
